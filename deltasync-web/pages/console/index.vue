<template>
  ...
  deltasync_flutter: ^1.0.0</code></pre>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="rounded-lg bg-white shadow">
                            <div class="p-6">
                                ...
                                <div class="mt-4">
                                    <div class="relative">
                                        <pre class="language-dart rounded-lg bg-gray-800 p-4"><code class="text-sm text-white">final deltasync = await DeltaSync.initialize(
