        ...
        <div class="mx-auto max-w-7xl px-6 pb-24 pt-10 sm:pb-32 lg:flex lg:px-8 lg:py-40">
            <div class="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
                ...
                <p class="mt-6 text-lg leading-8 text-gray-300">Build powerful offline-first applications with automatic
                    data
                    synchronization. DeltaSync handles the complexity of data sync, so you can focus on building great
                    features.
                </p>
                ...
                <div class="max-w-3xl flex-none sm:max-w-5xl lg:max-w-none">
                    <div class="rounded-xl bg-white/5 p-2 ring-1 ring-inset ring-white/10">
                        <div class="rounded-md bg-gray-900 p-4">
                            <pre class="text-sm leading-6 text-gray-300"><code>// Initialize DeltaSync
const deltasync = await DeltaSync.initialize({
  serverUrl: 'https://api.deltasync.dev',
