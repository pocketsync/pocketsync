                    ...
                    <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
                        <div class="overflow-hidden border border-gray-200 rounded-lg">
                            ...
                            <thead class="bg-gray-50">
                                <tr>
                                    <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-0">Token</th>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <tr v-for="token in authTokens" :key="token.id">
                                    ...
                                    <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                        <button @click="revokeToken(token.id)" class="text-red-600 hover:text-red-900">Revoke</button>
                                    </td>
                                </tr>
