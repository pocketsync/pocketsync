...
export * from './sync-activity-data-point';
export * from './sync-activity-dto';
export * from './sync-activity-period';
...
export * from './table-change-count-dto';
export * from './table-changes-summary-dto';
export * from './table-changes-summary-response-dto';
