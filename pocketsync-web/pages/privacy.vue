<template>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="space-y-8 prose prose-blue max-w-none">
            <section>
                <h2>Introduction</h2>
                <p>At PocketSync, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our service.</p>
            </section>
            ...
            <section>
                <h2>Contact Us</h2>
                <p>If you have any questions about this Privacy Policy, please contact us at privacy@pocketsync.io</p>
            </section>
        </div>
    </div>
</template>
