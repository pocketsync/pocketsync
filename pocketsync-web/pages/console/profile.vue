<template>
    ...
    <div>
        <div class="space-y-6">
            <!-- Profile section -->
            <div class="bg-white shadow-sm rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="mt-5 space-y-6">
                        <div v-if="user" class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                <label for="firstName" class="block text-sm font-medium text-gray-700 dark:text-gray-100">First
                                    name</label>
                            ...
                            <div>
                                <label for="lastName" class="block text-sm font-medium text-gray-700 dark:text-gray-100">Last name</label>
